const learn = () => {
  ...
  charenge.addEventListener('click', function(){
    ...
    question_answer[0] = ["「今までより速く」の意味を持つ音楽用語はどれ？","accel.","rit.","piu mosso","meno mosso","cresc.","a tempo",3];
    question_answer[1] = ["「今までより遅く」の意味を持つ音楽用語はどれ？","accel.","rit.","piu mosso","meno mosso","cresc.","a tempo",4];
    question_answer[2] = ["「小さく」の意味を持つ音量記号はどれ？","pp","p","mp","mf","f","ff",2];
    question_answer[3] = ["「とても小さく」の意味を持つ音量記号はどれ？","pp","p","mp","mf","f","ff",1];
    ...
    question_answer[25] = ["「少し大きく」の意味を持つ音量記号はどれ？","pp","p","mp","mf","f","ff",4];
    ...
    question_answer[37] = ["6/8拍子の時、4分音符の長さは？","0.5拍","1拍","1.5拍","2拍","3拍","4拍",4];
    question_answer[38] = ["6/8拍子の時、8分音符の長さは？","0.5拍","1拍","1.5拍","2拍","3拍","4拍",2];
    question_answer[39] = ["6/8拍子の時、2分音符の長さは？","0.5拍","1拍","1.5拍","2拍","3拍","4拍",6];
    question_answer[40] = ["6/8拍子の時、付点8分音符の長さは？","0.5拍","1拍","1.5拍","2拍","3拍","4拍",3];
    question_answer[41] = ["6/8拍子の時、付点4分音符の長さは？","0.5拍","1拍","1.5拍","2拍","3拍","4拍",5];
    question_answer[42] = ["6/8拍子の時、付点2分音符の長さは？","0.5拍","1拍","1.5拍","2拍","4拍","6拍",6];
    question_answer[43] = ["リタルダンドの意味は？","だんだん強く","だんだん速く","だんだん遅く","だんだん弱く","","",3];
    question_answer[44] = ["アッチェレランドの意味は？","だんだん強く","だんだん速く","だんだん遅く","だんだん弱く","","",2];
    question_answer[45] = ["「もとの速さで」の意味を持つ音楽用語はどれ？","accel.","rit.","piu mosso","meno mosso","cresc.","a tempo",6];
    question_answer[46] = ["Largo の意味は？","幅広く緩やかに","緩やかに","ゆっくり歩くような速さで","中ぐらいの速さで","速く","急速に",1];
    question_answer[47] = ["Lento の意味は？","幅広く緩やかに","緩やかに","ゆっくり歩くような速さで","中ぐらいの速さで","速く","急速に",2];
    question_answer[48] = ["Andante の意味は？","幅広く緩やかに","緩やかに","ゆっくり歩くような速さで","中ぐらいの速さで","速く","急速に",3];
    question_answer[49] = ["Moderato の意味は？","幅広く緩やかに","緩やかに","ゆっくり歩くような速さで","中ぐらいの速さで","速く","急速に",4];
    question_answer[50] = ["Allegro の意味は？","幅広く緩やかに","緩やかに","ゆっくり歩くような速さで","中ぐらいの速さで","速く","急速に",5];
    question_answer[51] = ["Presto の意味は？","幅広く緩やかに","緩やかに","ゆっくり歩くような速さで","中ぐらいの速さで","速く","急速に",6];
    question_answer[52] = ["♯ の意味は？","半音上げる","半音下げる","全音上げる","全音下げる","もとの高さに戻す","",1];
    question_answer[53] = ["♭ の意味は？","半音上げる","半音下げる","全音上げる","全音下げる","もとの高さに戻す","",2];
    question_answer[54] = ["♮ の意味は？","半音上げる","半音下げる","全音上げる","全音下げる","もとの高さに戻す","",5];
    question_answer[55] = ["♭♭ の意味は？","半音上げる","半音下げる","全音上げる","全音下げる","もとの高さに戻す","",3];
    question_answer[56] = ["×(♯♯) の意味は？","半音上げる","半音下げる","全音上げる","全音下げる","もとの高さに戻す","",4];
